  ...
  React.useEffect(() => {
    const onClick = (e) => {
      if (!rootEl.current.contains(e.target)) {
        ...
        if (
          document.getElementById("dropdown-button-drop-start").textContent !==
          "Меню"
        ) {
          setMenuStatus((menuStatus) => !menuStatus);
        }
      ...
      switch (type) {
        case "man":
          ...
          return isLoading
            ...
            : listMenu.map((item, index) => (
                <NavDropdown.Item href={`/show/${item.id}`}>
                  {curLng === "ru"
                    ? item.title
                    : item.titleTAT !== ""
                    ? item.titleTAT
                    : item.title}{" "}
                  {item.edro === "1" ? <img height="20px" src={ed} /> : ""}
                </NavDropdown.Item>
              ));
        case "kids":
        ...
        case "person":
          const listPerson = Object.keys(menu.person).map((key) => {
            return menu.person[key].map((item) => (
              <li>
                <NavDropdown.Item
                  href={`/person/${item.id}`}
                  className="text-break"
          ...
          <div className="row menu">
            <div className="col-4 ">
              <ul>
                ...
                <li>
                  <Link to="/news/" className="link-font">
                    {t("menu_read")}
                  </Link>
                </li>
              </ul>
                ...
                <li>
                  <NavDropdown title={t("menu_meet")} id="basic-nav-dropdown">
                    <div className="row">
                      ...
                      <ol className="artistList">{renderMenu("adm")}</ol>
                    </div>
                    <div className="row">
                      <h3 className="ps-3">{t("menu_artist")}</h3>
                      <ol className="artistList">{renderMenu("person")}</ol>
                    </div>
                  </NavDropdown>
                </li>
                <li>
                  <NavDropdown title={t("menu_about")} id="about-nav-dropdown">
                    <NavDropdown.Item href="/news/112" className="text-break">
                      {t("menu_about")}
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/167" className="text-break">
                      Фестивали
                    </NavDropdown.Item>
                  </NavDropdown>
                </li>
            ...
            <div className="col-4">
              <ul>
                <li className="pt-2">
                  <Link to="/news/165" className="link-font">
                    {t("menu_contact")}
                  </Link>
                </li>
                <li>
                  <NavDropdown title={t("menu_diff")} id="basic-nav-dropdown">
                    <NavDropdown.Item
                      href="https://xn--j1afdb.xn--80aa2abfodnqc1e7a6c.xn--80asehdb/form.php?i=296"
                      className="text-break"
                    >
                      Анкета-опросник
                    </NavDropdown.Item>
                    ...
                    <NavDropdown.Item href="/news/114" className="text-break">
                      Билеты и услуги
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/819" className="text-break">
                      Добрые дела
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/167" className="text-break">
                      Фестивали
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/122" className="text-break">
                      Закупки
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/514" className="text-break">
                      Отчет о выполнение гос. задания
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/515" className="text-break">
                      Независимая оценка качества оказания услуг
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/808" className="text-break">
                      Оказание бесплатной юридической помощи
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/809" className="text-break">
                      Политика в сфере противодействия коррупции
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/306" className="text-break">
                      Разное (ссылки)
                    </NavDropdown.Item>
                    <NavDropdown.Item href="/news/307" className="text-break">
                      Документы
                    </NavDropdown.Item>
                  </NavDropdown>
                </li>
          ...
          <div className="sab-menu">
            <div className="row p-0 m-0">
              <div className="col-6 p-0">
                <Link to="#" onClick={(e) => BlindClick(e)}>
                  {" "}
                  <img src={eye} />{" "}
                </Link>
              </div>
            ...
            <div className="row p-0 m-0">
              <div className="col-6 p-0">
                <a
                  href="https://www.youtube.com/channel/UC8FQlWOt3MjWsKX5Utp8niw"
                  target="_blank"
                >
                  {" "}
                  <img src={youtube} />{" "}
